...

{
   ...
   "dataset_reader": {
       "type": "multiprocess",
       "base_reader": BASE_READER(std.parseInt(std.extVar("LAZY_DATASET_READER")), std.extVar("COVARIATE_TRAIN_FILE"), std.extVar("COVARIATE_DEV_FILE")),
       "num_workers": std.extVar("NUM_WORKERS"),
   },
